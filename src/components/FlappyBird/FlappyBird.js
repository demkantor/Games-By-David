...
const FlappyBird = () => {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        SCORE_S.src = "/audio/flappy/sfx_point.wav";

        const FLAP = new Audio();
        FLAP.src = "/audio/flappy/sfx_flap.wav";

        const HIT = new Audio();
        HIT.src = "/audio/flappy/sfx_hit.wav";

        const SWOOSHING = new Audio();
        SWOOSHING.src = "/audio/flappy/sfx_swooshing.wav";

        const DIE = new Audio();
        DIE.src = "/audio/flappy/sfx_die.wav";
